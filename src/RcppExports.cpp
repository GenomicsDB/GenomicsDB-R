...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int >::type query_configuration_type(query_configuration_typeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(connect_with_query_json(query_configuration_json_file, query_configuration_type, loader_configuration_json_file, concurrency_rank));
    return rcpp_result_gen;
END_RCPP
}
// disconnect
...
// generate_vcf
void generate_vcf(Rcpp::XPtr<GenomicsDB> genomicsdb, const std::string& array, Rcpp::List column_ranges, Rcpp::List row_ranges, const std::string& reference_genome, const std::string& vcfheader_template, const std::string& output, const std::string& output_format, bool overwrite);
RcppExport SEXP _genomicsdb_generate_vcf(SEXP genomicsdbSEXP, SEXP arraySEXP, SEXP column_rangesSEXP, SEXP row_rangesSEXP, SEXP reference_genomeSEXP, SEXP vcfheader_templateSEXP, SEXP outputSEXP, SEXP output_formatSEXP, SEXP overwriteSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<GenomicsDB> >::type genomicsdb(genomicsdbSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type array(arraySEXP);
    ...
    Rcpp::traits::input_parameter< const std::string& >::type vcfheader_template(vcfheader_templateSEXP);
    ...
    generate_vcf(genomicsdb, array, column_ranges, row_ranges, reference_genome, vcfheader_template, output, output_format, overwrite);
    return R_NilValue;
END_RCPP
}
// generate_vcf_json
