...
gdb <- genomicsdb::connect(workspace = file.path(getwd(), "ws"), vid_mapping_file = "vid.json", callset_mapping_file = "callset_t0_1_2.json", reference_genome="chr1_10MB.fasta.gz", ("DP"), 40)
